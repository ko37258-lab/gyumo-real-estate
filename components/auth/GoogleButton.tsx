...
export function GoogleButton({ next = "/simulator" }: { next?: string }) {
  ...
  const handleGoogle = async () => {
    ...
    // 성공 시 구글로 리디렉션되므로 여기서 상태 정리 불필요
  };
  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="w-full rounded-lg py-2.5 font-semibold text-sm flex items-center justify-center gap-2.5 transition-opacity hover:opacity-90 disabled:opacity-60"
