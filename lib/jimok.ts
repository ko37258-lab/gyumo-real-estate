...
export const JIMOK_INFO: Record<string, JimokInfo> = {
  대: { value: "high", emoji: "house", desc: "건축 가능. 주거·상업·산업 모두 활용 가능한 최우선 지목", risk: "low" },
  잡종지: { value: "medium-high", emoji: "crane", desc: "지목변경 가능성 큼. 대지화 시 가치 상승", risk: "medium" },
  공장용지: { value: "high", emoji: "factory", desc: "산업단지·물류 활용", risk: "low" },
  창고용지: { value: "high", emoji: "warehouse", desc: "산업·물류 활용", risk: "low" },
  학교용지: { value: "medium", emoji: "school", desc: "공익 목적. 매매 제한적", risk: "medium" },
  전: { value: "medium", emoji: "wheat", desc: "농지. 농지법 적용. 농업진흥구역이면 전용 어려움", risk: "medium-high" },
  답: { value: "medium", emoji: "wheat", desc: "논. 농지법 적용. 농지전용허가 필요", risk: "medium-high" },
  과수원: { value: "medium", emoji: "", desc: "농지. 농지법 적용", risk: "medium-high" },
  목장용지: { value: "low-medium", emoji: "", desc: "농지 또는 임야 성격", risk: "medium" },
  임야: { value: "low", emoji: "mountain", desc: "산림법 적용. 형질변경·건축 매우 제한적", risk: "high" },
  도로: { value: "none", emoji: "road", desc: "도로 자체. 건축 불가", risk: "n/a" },
  하천: { value: "none", emoji: "mountain", desc: "하천부지. 건축 불가", risk: "n/a" },
  구거: { value: "none", emoji: "mountain", desc: "수로. 건축 불가", risk: "n/a" },
  유지: { value: "low", emoji: "mountain", desc: "저수지·연못. 건축 제한적", risk: "high" },
  제방: { value: "none", emoji: "mountain", desc: "제방. 건축 불가", risk: "n/a" },
  주차장: { value: "medium", emoji: "car", desc: "주차 전용. 다른 용도 활용 제한", risk: "medium" },
  주유소용지: { value: "medium", emoji: "", desc: "주유소 전용", risk: "medium" },
  공원: { value: "low", emoji: "tree", desc: "공원시설. 건축 매우 제한적", risk: "high" },
  체육용지: { value: "low", emoji: "", desc: "체육시설용", risk: "medium" },
  유원지: { value: "low", emoji: "", desc: "관광·유원지용", risk: "medium" },
  종교용지: { value: "low", emoji: "courthouse", desc: "종교시설용", risk: "medium" },
  사적지: { value: "none", emoji: "courthouse", desc: "문화재. 개발 불가", risk: "n/a" },
  묘지: { value: "low", emoji: "", desc: "묘지. 매우 제한적", risk: "high" },
  염전: { value: "low", emoji: "", desc: "염전. 매우 제한적", risk: "high" },
  양어장: { value: "low", emoji: "", desc: "양어장. 매우 제한적", risk: "high" },
  철도용지: { value: "none", emoji: "subway", desc: "철도시설용. 건축 불가", risk: "n/a" },
...
export function getJimokInfo(name: string | null | undefined): JimokInfo {
  ...
  if (!normalized)
    return { value: "low", emoji: "question", desc: "지목 정보 미확인", risk: "medium" };
  return (
